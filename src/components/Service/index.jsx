    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="section-title text-center mb-4 pb-2">
                <h4 class="title mb-4">MANAGEMENT SERVICES</h4>
                <p class="text-muted para-desc mx-auto mb-0">OWNERSHIP WITHOUT THE HASSLE</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h5 class="title">RENT COLLECTION</h5>
                    <p class="text-muted mt-3 mb-0">Tenants can pay their rent online, in real time, via electronic fund transfers or even pay by credit card. Through this technology, we can offer our owners up-to-date information on demand and in a clean detailed fashion.</p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h5 class="title">RENT INVOICING</h5>
                    <p class="text-muted mt-3 mb-0">In order to help your tenants stay on top of rent payments, we send out monthly invoices (including a detailed breakdown of charges to their account) to remind them to payment is coming due.</p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    ...
                    <p class="text-muted mt-3 mb-0">We pay all vendors on behalf of the property on time and such information is automatically compiled for owners to review at any time they desire. Our property managers adhere to strict standards of review when hiring & reviewing a vendor’s work.</p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h5 class="title">REPAIR & MAINTANANCE</h5>
                    <p class="text-muted mt-3 mb-0">Outside of responsiveness and organization, we thoroughly screen all of the vendors we work with to ensure your property is getting the best possible repair and/or maintenance work for the best possible price.</p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    ...
                    <p class="text-muted mt-3 mb-0">Running a property is no different than running a business. We provide monthly, quarterly, and annual financial reports. Also, with our on-demand system, our clients can access financial reports in a moment’s notice.</p>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div class="card service-wrapper rounded border-0 shadow p-4">
                ...
                <div class="content mt-4">
                    <h5 class="title">Apartment Turnover Services</h5>
                    <p class="text-muted mt-3 mb-0">After a tenant notifies us of their intent to move, we reply by scheduling a pre-move out inspection and we send them a Move Out Letter, which states the expectations regarding the condition of the property.</p>
