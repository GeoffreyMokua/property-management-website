          ...
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              ...
              <p class="text-muted mt-3 mb-0">
                ...
                charges to their account) to remind them to payment is coming
                due.
              </p>
            </div>
            <div class="big-icon h1 text-custom">
          ...
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              ...
              <p class="text-muted mt-3 mb-0">
                ...
                information is automatically compiled for owners to review at
                any time they desire. Our property managers adhere to strict
                standards of review when hiring & reviewing a vendor’s work.
              </p>
            </div>
            <div class="big-icon h1 text-custom">
              <span class="uim-svg">
          ...
          <div class="card service-wrapper rounded border-0 shadow p-4">
            ...
            <div class="content mt-4">
              ...
              <p class="text-muted mt-3 mb-0">
                ...
                all of the vendors we work with to ensure your property is
                getting the best possible repair and/or maintenance work for the
                best possible price.
              </p>
            </div>
            <div class="big-icon h1 text-custom">
